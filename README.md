...
.
   ...
   got the above from  Kristoffer Andreasen

1) You Need to run npm install to install all dependcies
2) THen download the the project from github
3) Enter the command line where the project is
4) use ionic serve to run a web broswer mode or ionic serve --labs to see how the mobile version works 
